 <div class="menu">
     <div class="wrap-content">
         <ul class="menu-main">
             <li>
                 <a href="http://127.0.0.1:8000/" title="Trang chủ" title="Trang chủ">
                     Trang chủ
                 </a>
             </li>
             <li>
                 <a href="{{ route('product') }}" title="Sản phẩm" title="Sản phẩm">Sản phẩm
                 </a>
             </li>
             <li>
                 <a href="{{ route('aboutus') }}" title="Về chúng tôi" title="Về chúng tôi">
                     Về chúng tôi
                 </a>
             </li>
             <li>
                 <a href="{{ route('news') }}" title="Tin tức & sự kiện" title="Tin tức & sự kiện">
                     Tin tức & sự kiện
                 </a>
             </li>

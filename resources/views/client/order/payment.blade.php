                    ...
                    <div class="section-cart">
                        ...
                        <form action="{{ route('cod') }}" method="POST">
                            ...
                            <div class="information-cart">
                                    ...
                                    <div class="input-cart col-md-6 mg-col-10">
                                        <div class="form-floating form-floating-cus">
                                            <input type="text" class="form-control text-sm" id="fullname"
                                                ...
                                                value="{{ $user->last_name . ' ' . $user->first_name }}" required /> <label
                                                for="fullname">Họ
                                                tên</label>
                                        </div>
                                ...
                                <div class="input-cart">
                                    <div class="form-floating form-floating-cus">
                                        <textarea class="form-control text-sm" id="note" name="note" placeholder="Yêu cầu khác"> </textarea> <label for="note">Yêu cầu khác</label>
                                    </div>
                                </div>
                            </div>

...
<html lang="en">
    ...
    <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
        ...
        <script type="text/javascript"
            src="jquery.pixelentity.shiner.min.js"></script>
                            ...
                            <div class="header-bottom-contact">
                                <div class="flex-header-bottom-contact">
                                    <div class="header-bottom-contact-img">
                                        <img
                                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsUrVUDIHp1hRpBesplVZXHOaKfLI2oyxpgQ&s"
                                            alt>
                                    </div>
                                    <div class="header-bottom-contact-info">
                                        ...
                                        <div class="header-bottom-contact-num">
                                            <a
                                                href="tel:0768848015">0768848015</a>
                                        </div>
                                        <div class="header-bottom-contact-num">
                                            <a
                                                href="tel:0768848015">0768848015</a>
                            ...
                            <div class="header-bottom-personalized">
                                <div class="flex-header-bottom-personalized">
                                    <div class="header-bottom-account-positon">
                                        <div id="open-user-btn"
                                            class="header-bottom-account">
                                            <div
                                                class="header-bottom-account-icon">
                                                <i class="fa-solid fa-user"></i>
                                            </div>
                                            <div
                                                class="header-bottom-account-text">
                                                Tài khoản
                                            </div>
                                        </div>
                                        <div
                                            class="header-bottom-account-hidden">
                                            <div
                                                class="header-bottom-account-hidden-cover">
                                                <div
                                                    class="flex-header-bottom-account-hidden-cover">
                                                    <div
                                                        class="header-bottom-account-hidden-cover-text">
                                                ...
                                                <div
                                                    class="header-bottom-account-hidden-btn">
                                                    <div
                                                        class="flex-header-bottom-account-hidden-btn">
                                                        <div
                                                            class="header-bottom-account-hidden-login">
                                                            <a href="login">Đăng
                                                                nhập</a>
                                                        </div>
                                                        <div
                                                            class="header-bottom-account-hidden-register">
                                                            <a
                                                                href="register">Đăng
                                                                ký</a>
                                                        </div>
                                    ...
                                    <div
                                        class="header-bottom-cart-icon-position">
                                        <div id="open-cart-list"
                                            class="header-bottom-cart">
                                            <div
                                                class="header-bottom-cart-icon">
                                                <i
                                                    class="fa-solid fa-cart-shopping"></i>
                                                <div
                                                    class="header-bottom-cart-num">
                                                    0
                                                </div>
                                            </div>
                                            <div
                                                class="header-bottom-cart-text">
                                                Giỏ hàng
                                            </div>
                                        </div>
                                        <div
                                            class="header-bottom-cart-icon-hidden">
                                            <div
                                                class="flex-header-bottom-cart-icon-hidden-cover">
                                                <div
                                                    class="header-bottom-cart-icon-hidden-cover-text">
                                            ...
                                            <div
                                                class="header-bottom-cart-list">
                                                <!-- If here -->
                                                <div
                                                    class="header-bottom-cart-list-scroll">

                                                </div>

                                                <div
                                                    class="header-bottom-cart-list-none">
